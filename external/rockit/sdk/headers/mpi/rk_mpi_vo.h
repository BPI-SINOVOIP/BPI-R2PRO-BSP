...
RK_S32 RK_MPI_VO_Get_Edid(RK_U32 enIntfType, VO_EDID_S *pstEdidData);
RK_S32 RK_MPI_VO_GetSinkCapability(RK_U32 enIntfType, VO_SINK_CAPABILITY_S *pstSinkCap);

RK_S32 RK_MPI_VO_RegCallbackFunc(RK_U32 enIntfType, RK_VO_CALLBACK_FUNC_S *pstCallbackFunc);
RK_S32 RK_MPI_VO_UnRegCallbackFunc(RK_U32 enIntfType, RK_VO_CALLBACK_FUNC_S *pstCallbackFunc);
