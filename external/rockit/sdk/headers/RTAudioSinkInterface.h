...
typedef enum {
    ...
    AAUDIO_FORMAT_AAC                 = 0x04000000u,
    AAUDIO_FORMAT_HE_AAC_V1           = 0x05000000u,
    AAUDIO_FORMAT_HE_AAC_V2           = 0x06000000u,
    AAUDIO_FORMAT_VORBIS              = 0x07000000u,
    AAUDIO_FORMAT_OPUS                = 0x08000000u,
    AAUDIO_FORMAT_AC3                 = 0x09000000u,
    AAUDIO_FORMAT_E_AC3               = 0x0A000000u,
    AAUDIO_FORMAT_DTS                 = 0x0B000000u,
    AAUDIO_FORMAT_DTS_HD              = 0x0C000000u,
    AAUDIO_FORMAT_IEC61937            = 0x0D000000u,
    AAUDIO_FORMAT_DOLBY_TRUEHD        = 0x0E000000u,
    ...
    AAUDIO_FORMAT_AAC_ADIF            = 0x14000000u,
    ...
    AAUDIO_FORMAT_AAC_ADTS            = 0x1E000000u,
    ...
    AAUDIO_FORMAT_AAC_LATM            = 0x25000000u,
    ...
    AAUDIO_FORMAT_AAC_SUB_MAIN          = 0x1u,
    AAUDIO_FORMAT_AAC_SUB_LC            = 0x2u,
    AAUDIO_FORMAT_AAC_SUB_SSR           = 0x4u,
    AAUDIO_FORMAT_AAC_SUB_LTP           = 0x8u,
    AAUDIO_FORMAT_AAC_SUB_HE_V1         = 0x10u,
    AAUDIO_FORMAT_AAC_SUB_SCALABLE      = 0x20u,
    AAUDIO_FORMAT_AAC_SUB_ERLC          = 0x40u,
    AAUDIO_FORMAT_AAC_SUB_LD            = 0x80u,
    AAUDIO_FORMAT_AAC_SUB_HE_V2         = 0x100u,
    AAUDIO_FORMAT_AAC_SUB_ELD           = 0x200u,
    AAUDIO_FORMAT_AAC_SUB_XHE           = 0x300u,

    AAUDIO_FORMAT_VORBIS_SUB_NONE       = 0x0u,

    AAUDIO_FORMAT_E_AC3_SUB_JOC         = 0x1u,
    ...
    AAUDIO_FORMAT_AAC_MAIN              = 0x4000001u,   // (AAC | AAC_SUB_MAIN)
    AAUDIO_FORMAT_AAC_LC                = 0x4000002u,   // (AAC | AAC_SUB_LC)
    AAUDIO_FORMAT_AAC_SSR               = 0x4000004u,   // (AAC | AAC_SUB_SSR)
    AAUDIO_FORMAT_AAC_LTP               = 0x4000008u,   // (AAC | AAC_SUB_LTP)
    AAUDIO_FORMAT_AAC_HE_V1             = 0x4000010u,   // (AAC | AAC_SUB_HE_V1)
    AAUDIO_FORMAT_AAC_SCALABLE          = 0x4000020u,   // (AAC | AAC_SUB_SCALABLE)
    AAUDIO_FORMAT_AAC_ERLC              = 0x4000040u,   // (AAC | AAC_SUB_ERLC)
    AAUDIO_FORMAT_AAC_LD                = 0x4000080u,   // (AAC | AAC_SUB_LD)
    AAUDIO_FORMAT_AAC_HE_V2             = 0x4000100u,   // (AAC | AAC_SUB_HE_V2)
    AAUDIO_FORMAT_AAC_ELD               = 0x4000200u,   // (AAC | AAC_SUB_ELD)
    AAUDIO_FORMAT_AAC_XHE               = 0x4000300u,   // (AAC | AAC_SUB_XHE)
    AAUDIO_FORMAT_AAC_ADTS_MAIN         = 0x1e000001u,  // (AAC_ADTS | AAC_SUB_MAIN)
    AAUDIO_FORMAT_AAC_ADTS_LC           = 0x1e000002u,  // (AAC_ADTS | AAC_SUB_LC)
    AAUDIO_FORMAT_AAC_ADTS_SSR          = 0x1e000004u,  // (AAC_ADTS | AAC_SUB_SSR)
    AAUDIO_FORMAT_AAC_ADTS_LTP          = 0x1e000008u,  // (AAC_ADTS | AAC_SUB_LTP)
    AAUDIO_FORMAT_AAC_ADTS_HE_V1        = 0x1e000010u,  // (AAC_ADTS | AAC_SUB_HE_V1)
    AAUDIO_FORMAT_AAC_ADTS_SCALABLE     = 0x1e000020u,  // (AAC_ADTS | AAC_SUB_SCALABLE)
    AAUDIO_FORMAT_AAC_ADTS_ERLC         = 0x1e000040u,  // (AAC_ADTS | AAC_SUB_ERLC)
    AAUDIO_FORMAT_AAC_ADTS_LD           = 0x1e000080u,  // (AAC_ADTS | AAC_SUB_LD)
    AAUDIO_FORMAT_AAC_ADTS_HE_V2        = 0x1e000100u,  // (AAC_ADTS | AAC_SUB_HE_V2)
    AAUDIO_FORMAT_AAC_ADTS_ELD          = 0x1e000200u,  // (AAC_ADTS | AAC_SUB_ELD)
    AAUDIO_FORMAT_AAC_ADTS_XHE          = 0x1e000300u,  // (AAC_ADTS | AAC_SUB_XHE)
    AAUDIO_FORMAT_AAC_LATM_LC           = 0x25000002u,  // (AAC_LATM | AAC_SUB_LC)
    AAUDIO_FORMAT_AAC_LATM_HE_V1        = 0x25000010u,  // (AAC_LATM | AAC_SUB_HE_V1)
    AAUDIO_FORMAT_AAC_LATM_HE_V2        = 0x25000100u,  // (AAC_LATM | AAC_SUB_HE_V2)
    AAUDIO_FORMAT_E_AC3_JOC             = 0xA000001u,   // (E_AC3 | E_AC3_SUB_JOC)
