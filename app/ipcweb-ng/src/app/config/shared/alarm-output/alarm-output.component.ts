...
@Component({
  selector: 'app-alarm-output',
  templateUrl: './alarm-output.component.html',
  styleUrls: ['./alarm-output.component.scss']
})
export class AlarmOutputComponent implements OnInit {
