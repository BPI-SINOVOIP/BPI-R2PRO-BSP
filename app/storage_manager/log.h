...
extern int storage_manager_log_level;
...
#ifndef LOG_TAG
#define LOG_TAG "storage_manager"
#endif // LOG_TAG

#define LOG_INFO(format, ...)                                                  \
  do {                                                                         \
    if (storage_manager_log_level < LOG_LEVEL_INFO)                            \
      break;                                                                   \
    if (enable_minilog)                                                        \
...
#define LOG_WARN(format, ...)                                                  \
  do {                                                                         \
    if (storage_manager_log_level < LOG_LEVEL_WARN)                            \
      break;                                                                   \
    if (enable_minilog)                                                        \
...
#define LOG_ERROR(format, ...)                                                 \
  do {                                                                         \
    if (storage_manager_log_level < LOG_LEVEL_ERROR)                           \
      break;                                                                   \
    if (enable_minilog)                                                        \
...
#define LOG_DEBUG(format, ...)                                                 \
  do {                                                                         \
    if (storage_manager_log_level < LOG_LEVEL_DEBUG)                           \
      break;                                                                   \
    if (enable_minilog)                                                        \
