 ...
 * \return OPERATE_RET
 * \caution! this API will no longer supported, and currently only motion detect and doorbell type event are supported
 */
 ...
 * \return OPERATE_RET
 * \caution! this API will no longer supported, and currently both motion detect and doorbell type events will be stopped
 */
