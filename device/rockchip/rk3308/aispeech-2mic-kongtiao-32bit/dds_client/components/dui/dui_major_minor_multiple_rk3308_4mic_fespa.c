...
static void recorder_run(void *args) {
    ...
    while (1) {
        ...
        if (m.type == RECORDER_CMD_START) {
            ...
            system("tinymix set 27 3");
            system("tinymix set 28 3");
            system("tinymix set 29 3");
            system("tinymix set 30 3");
            system("tinymix set 31 3");

            system("tinymix set 35 5");
            system("tinymix set 36 16");
            system("tinymix set 37 16");
            system("tinymix set 38 16");
            system("tinymix set 39 16");
