...
static void recorder_run(void *args) {
    ...
    while (1) {
        ...
        if (m.type == RECORDER_CMD_START) {
            ...
            system("tinymix set \"ALC AGC Group 1 Left Volume\" 20");
            system("tinymix set \"ALC AGC Group 1 Right Volume\" 20");
            system("tinymix set \"ALC AGC Group 2 Left Volume\" 31");
            system("tinymix set \"ALC AGC Group 2 Right Volume\" 31");
            system("tinymix set \"ALC AGC Group 3 Left Volume\" 31");
            system("tinymix set \"ALC AGC Group 3 Right Volume\" 31");

            system("tinymix set \"ADC MIC Group 1 Left Volume\" 2");
            system("tinymix set \"ADC MIC Group 1 Right Volume\" 2");
            system("tinymix set \"ADC MIC Group 2 Left Volume\" 3");
            system("tinymix set \"ADC MIC Group 2 Right Volume\" 3");
            system("tinymix set \"ADC MIC Group 3 Left Volume\" 3");
            system("tinymix set \"ADC MIC Group 3 Right Volume\" 3");

            system("tinymix set \"ADC ALC Group 1 Left Volume\" 20");
            system("tinymix set \"ADC ALC Group 1 Right Volume\" 20");
            system("tinymix set \"ADC ALC Group 2 Left Volume\" 31");
            system("tinymix set \"ADC ALC Group 2 Right Volume\" 31");
            system("tinymix set \"ADC ALC Group 3 Left Volume\" 31");
            system("tinymix set \"ADC ALC Group 3 Right Volume\" 31");
